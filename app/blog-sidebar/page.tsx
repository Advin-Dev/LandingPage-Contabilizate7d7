import RelatedPost from "@/components/Modulos/RelatedPost";
import SharePost from "@/components/Modulos/SharePost";
import TagButton from "@/components/Modulos/TagButton";
                    ...
                    <div className="mb-5 mr-10 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image
                            src="/images/modulos/author-02.png"
                            alt="author"
                            fill
                          />
                        </div>
                ...
                <div>
                  ...
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      <Image
                        src="/images/modulos/modulos-details-01.jpg"
                        alt="image"
                        fill
                ...
                <ul className="p-8">
                  <li className="mb-6 border-b border-body-color border-opacity-10 pb-6 dark:border-white dark:border-opacity-10">
                    <RelatedPost
                      ...
                      image="/images/modulos/post-01.jpg"
                      slug="#"
                      date="12 Feb 2025"
                    />
                  </li>
                  <li className="mb-6 border-b border-body-color border-opacity-10 pb-6 dark:border-white dark:border-opacity-10">
                    <RelatedPost
                      ...
                      image="/images/modulos/post-02.jpg"
                      slug="#"
                      date="15 Feb, 2024"
                    />
                  </li>
                  <li>
                    <RelatedPost
                      ...
                      image="/images/modulos/post-03.jpg"
                      slug="#"
                      date="05 Jun, 2024"
                    />
                  </li>
